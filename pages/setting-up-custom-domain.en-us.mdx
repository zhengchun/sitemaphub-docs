...
When your created a new sitemap or RSS for your site, by default, you access your feed only via feed.sitemaphub.com

SitemapHub allows your setting a custom domain to access your sitemaps and RSS, it's better rather than by default. for example: “https://your-custom-domain/{name}”
...
- In the **Value/Answer/Destination** field, enter **<u>cname.sitemaphub.com.</u>**.
- Save the record.
...
** 4. Click “Save” if set up done. If all done, shown below:**
...
After you've correctly configured a DNS record, SitemapHub will attempt to generate an SSL certification on your behalf! 

SitemapHub uses [Let's Encrypt](https://letsencrypt.org/) to create SSL certificate for your custom domain, and automaticlly renewal until you cancel this custom domain. 
